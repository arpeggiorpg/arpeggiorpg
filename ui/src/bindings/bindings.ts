...
export type CombatLog = { "t": "ConsumeMovement", distance: number, } | { "t": "ChangeCreatureInitiative", creature_id: CreatureID, new_initiative: number, } | { "t": "EndTurn", creature_id: CreatureID, } | { "t": "ForceNextTurn" } | { "t": "ForcePrevTurn" } | { "t": "RerollInitiative", combatants: Array<[CreatureID, number]>, };
