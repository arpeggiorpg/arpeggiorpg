...
export type PlayerCommand = { ChatFromPlayer: string } | { EditNote: { path: FolderPath, name: string, note: Note, } } | { ActCreature: { creature_id: CreatureID, ability_id: AbilityID, target: DecidedTarget, } } | { PathCreature: { creature_id: CreatureID, destination: Point3, } } | { CombatAct: { ability_id: AbilityID, target: DecidedTarget, } } | { PathCurrentCombatCreature: Point3 } | "EndTurn";
