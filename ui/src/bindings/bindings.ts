...
export type GameLog = { "LoadModule": { name: string, source: ModuleSource, path: FolderPath, } } | { "SetActiveScene": SceneID | null } | { "RegisterPlayer": PlayerID } | { "GiveCreaturesToPlayer": [PlayerID, Array<CreatureID>] } | { "UnregisterPlayer": PlayerID } | { "RemoveCreaturesFromPlayer": [PlayerID, Array<CreatureID>] } | { "SetPlayerScene": [PlayerID, SceneID | null] } | { "ChatFromGM": string } | { "ChatFromPlayer": [PlayerID, string] } | { "AttributeCheckResult": { creature_id: CreatureID, attribute_check: AttributeCheck, actual: number, success: boolean, } } | { "CreateFolder": FolderPath } | { "RenameFolder": [FolderPath, string] } | { "MoveFolderItem": [FolderPath, FolderItemID, FolderPath] } | { "CopyFolderItem": { source: FolderPath, item_id: FolderItemID, dest: FolderPath, new_item_id: FolderItemID, } } | { "DeleteFolderItem": [FolderPath, FolderItemID] } | { "CreateItem": [FolderPath, Item] } | { "EditItem": Item } | { "CreateNote": [FolderPath, Note] } | { "EditNote": [FolderPath, string, Note] } | { "TransferItem": { from: InventoryOwner, to: InventoryOwner, item_id: ItemID, count: bigint, } } | { "RemoveItem": { owner: InventoryOwner, item_id: ItemID, count: bigint, } } | { "SetItemCount": { owner: InventoryOwner, item_id: ItemID, count: bigint, } } | { "CreateScene": [FolderPath, Scene] } | { "EditSceneDetails": { scene_id: SceneID, details: SceneCreation, } } | { "SetSceneCreatureVisibility": { scene_id: SceneID, creature_id: CreatureID, visibility: Visibility, } } | { "AddCreatureToScene": { scene_id: SceneID, creature_id: CreatureID, visibility: Visibility, } } | { "RemoveCreatureFromScene": { scene_id: SceneID, creature_id: CreatureID, } } | { "AddSceneChallenge": { scene_id: SceneID, description: string, challenge: AttributeCheck, } } | { "RemoveSceneChallenge": { scene_id: SceneID, description: string, } } | { "SetFocusedSceneCreatures": { scene_id: SceneID, creatures: Array<CreatureID>, } } | { "RemoveSceneVolumeCondition": { scene_id: SceneID, condition_id: ConditionID, } } | { "EditSceneTerrain": { scene_id: SceneID, terrain: Terrain, } } | { "EditSceneHighlights": { scene_id: SceneID, highlights: Highlights, } } | { "EditSceneAnnotations": { scene_id: SceneID, annotations: Annotations, } } | { "EditSceneRelatedScenes": { scene_id: SceneID, related_scenes: RelatedScenes, } } | { "EditSceneSceneHotspots": { scene_id: SceneID, scene_hotspots: SceneHotspots, } } | { "CombatLog": CombatLog } | { "CreatureLog": [CreatureID, CreatureLog] } | { "SetCreaturePos": [SceneID, CreatureID, Point3] } | { "PathCreature": [SceneID, CreatureID, Array<Point3>] } | { "AddVolumeCondition": { scene_id: SceneID, point: Point3, volume: Volume, condition_id: ConditionID, condition: Condition, duration: Duration, } } | { "StartCombat": [SceneID, Array<[CreatureID, number]>] } | "StopCombat" | { "CreateClass": { path: FolderPath, class: ClassCreation, } } | { "EditClass": { class_id: ClassID, class: ClassCreation, } } | { "CreateAbility": { path: FolderPath, ability: AbilityCreation, } } | { "EditAbility": { ability_id: AbilityID, ability: AbilityCreation, } } | { "CreateCreature": [FolderPath, CreatureData] } | { "EditCreatureDetails": { creature_id: CreatureID, details: CreatureCreation, } } | { "AddCreatureToCombat": [CreatureID, number] } | { "RemoveCreatureFromCombat": CreatureID } | { "Rollback": [number, number] };

export type GMCommand = { "LoadModule": { name: string, source: ModuleSource, game: Game, path: FolderPath, } } | { "ChatFromGM": string } | { "AttributeCheck": [CreatureID, AttributeCheck] } | { "CreateFolder": FolderPath } | { "RenameFolder": [FolderPath, string] } | { "MoveFolderItem": [FolderPath, FolderItemID, FolderPath] } | { "CopyFolderItem": { source: FolderPath, item_id: FolderItemID, dest: FolderPath, } } | { "DeleteFolderItem": [FolderPath, FolderItemID] } | { "CreateItem": [FolderPath, string] } | { "EditItem": Item } | { "CreateNote": [FolderPath, Note] } | { "EditNote": [FolderPath, string, Note] } | { "TransferItem": { from: InventoryOwner, to: InventoryOwner, item_id: ItemID, count: bigint, } } | { "RemoveItem": { owner: InventoryOwner, item_id: ItemID, count: bigint, } } | { "SetItemCount": { owner: InventoryOwner, item_id: ItemID, count: bigint, } } | { "CreateScene": [FolderPath, SceneCreation] } | { "EditSceneDetails": { scene_id: SceneID, details: SceneCreation, } } | { "SetSceneCreatureVisibility": { scene_id: SceneID, creature_id: CreatureID, visibility: Visibility, } } | { "AddCreatureToScene": { scene_id: SceneID, creature_id: CreatureID, visibility: Visibility, } } | { "RemoveCreatureFromScene": { scene_id: SceneID, creature_id: CreatureID, } } | { "AddSceneChallenge": { scene_id: SceneID, description: string, challenge: AttributeCheck, } } | { "RemoveSceneChallenge": { scene_id: SceneID, description: string, } } | { "SetFocusedSceneCreatures": { scene_id: SceneID, creatures: Array<CreatureID>, } } | { "RemoveSceneVolumeCondition": { scene_id: SceneID, condition_id: ConditionID, } } | { "EditSceneTerrain": { scene_id: SceneID, terrain: Terrain, } } | { "EditSceneHighlights": { scene_id: SceneID, highlights: Highlights, } } | { "EditSceneAnnotations": { scene_id: SceneID, annotations: Annotations, } } | { "EditSceneRelatedScenes": { scene_id: SceneID, related_scenes: RelatedScenes, } } | { "EditSceneSceneHotspots": { scene_id: SceneID, scene_hotspots: SceneHotspots, } } | { "StartCombat": [SceneID, Array<CreatureID>] } | "StopCombat" | { "AddCreatureToCombat": CreatureID } | { "RemoveCreatureFromCombat": CreatureID } | { "ChangeCreatureInitiative": [CreatureID, number] } | "RerollCombatInitiative" | "ForceNextTurn" | "ForcePrevTurn" | { "ActCreature": { scene_id: SceneID, creature_id: CreatureID, ability_id: AbilityID, target: DecidedTarget, } } | { "CombatAct": { ability_id: AbilityID, target: DecidedTarget, } } | { "PathCurrentCombatCreature": Point3 } | "EndTurn" | { "CreateClass": { path: FolderPath, class: ClassCreation, } } | { "EditClass": { class_id: ClassID, class: ClassCreation, } } | { "CreateAbility": { path: FolderPath, ability: AbilityCreation, } } | { "EditAbility": { ability_id: AbilityID, ability: AbilityCreation, } } | { "CreateCreature": [FolderPath, CreatureCreation] } | { "EditCreatureDetails": { creature_id: CreatureID, details: CreatureCreation, } } | { "SetCreaturePos": [SceneID, CreatureID, Point3] } | { "PathCreature": { scene_id: SceneID, creature_id: CreatureID, destination: Point3, } } | { "RegisterPlayer": PlayerID } | { "GiveCreaturesToPlayer": [PlayerID, Array<CreatureID>] } | { "UnregisterPlayer": PlayerID } | { "RemoveCreaturesFromPlayer": [PlayerID, Array<CreatureID>] } | { "SetPlayerScene": [PlayerID, SceneID | null] } | { "SetActiveScene": SceneID | null } | { "Rollback": [number, number] };
...
export type PlayerCommand = { "ChatFromPlayer": string } | { "EditNote": { path: FolderPath, name: string, note: Note, } } | { "PathCreature": { creature_id: CreatureID, destination: Point3, } } | { "CombatAct": { ability_id: AbilityID, target: DecidedTarget, } } | { "PathCurrentCombatCreature": Point3 } | "EndTurn";
